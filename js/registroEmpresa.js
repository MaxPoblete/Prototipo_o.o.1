...
listaEmpresasIss.forEach(empresaISS => {
    agregarEmpresaISSLocalStorage(empresaISS);
});
...
function agregarEmpresaISSLocalStorage(empresaISS) {

    let listaEmpresasISS;

    listaEmpresasISS = obtenerEmpresasISSLocalStorage();
    listaEmpresasISS.push(empresaISS);
    localStorage.setItem('listaEmpresasISS', JSON.stringify(listaEmpresasISS) );
}
